...
for evaluating certain strategies. We aim to model key aspects of the 
...
infinite supply under the contraint of the inter-arrival time capability of the 
supplier, and continuous demand driven by the anticipation of a disaster and then the disaster itself.
This assumption was
...
relief items, is considered a fair reflection of the 
...
only one truck servicing both distribution sites. It is unclear as to why supplies appeared to 
...
of stock to preposition, versus time to deliver relief (efficiency) and also 
...
number of warehouse centres (possibly modelling the movement from an in-country
central warehouse to district level warehouses that hold supplies prior to 
pre-planned distributions). The notion of security and risk may consequently 
