...
optimal time to reach/gain access to the distribution site is approximately 4 
...
the arrival and queuing times of beneficiaries at a distribution site and the 
capacity to serve the queue based on incoming supplies. One hypothesis is that at 
4 hours time to access the distribution site, sufficient numbers of beneficiaries 
have accumulated to effectively service more people more quickly with all 
available supplies on the truck. Quicker arrival times of trucks to the sites may
imply that few people are waiting in queues at the distribution site. Moreover 
longer access times may mean that the buffer queue of beneficiaries is not being 
cleared in the most optimal manner (recall the capacity of the trucks are 
...
Adding a financial analysis component to the the models to assess the cost of 
supplies provided by the different modes of reliable suppliers. Also the 
opportunity of wait times for beneficiaries.

Finding optimal solutions in terms of amount of stock to preposition, versus 
time to relieved (efficiency) and also wastage (spoiled supplies)

Growing the entities to encompass more complexity of local supply chain systems,
such as greater number of warehouse centres (possible modelling the movement from 
an in country central warehouse to district level warehouses that hold supplies
prior to pre-planned distributions in the foreseeable future). The notion of 
security and risk may be better encompassed in such models, as the security risks 
